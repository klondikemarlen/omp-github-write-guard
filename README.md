...
- An unqualified `git push` resolves `branch.<name>.pushRemote`, `remote.pushDefault`, the current branch upstream, then `origin`, matching Git's destination precedence.
